...
class _TransactionDetailsState extends State<TransactionDetails> {
  ...
  Widget build(BuildContext context) {
    return Consumer<TransactionProvider>(builder: (_, data, __) {
      final transaction = data.transactionDetail;
      return Scaffold(
                                    ...
                                    child: Text.rich(
                                      TextSpan(
                                        children: [
                                          ...
                                          TextSpan(
                                            text:
                                                "XAF ${transaction.payload['amount_paid']} ",
                                            style: Theme.of(context)
                                                .textTheme
                                                .bodyText1!
                                                .copyWith(
                                  ...
                                  child: Container(
                                    ...
                                    child: Column(
                                      children: [
                                        ...
                                        // {"success":true,"transactions":[{"id":12,"type":"momo",
                                        // "payload":{"date":"2024-05-02T18:43:32.101082Z","type":"momo",
                                        // "sender":{"name":null,"phone":"670260611"},"receiver":{"name":"Kenc","phone":"8623762378"},
                                        // "amount_paid":"4000","amount_to_send":"4000"},"date":"2024-05-02T18:43:32.000000Z"}
